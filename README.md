...
2. Abre en el navegador:
   - **http://macromedhorus.com** (redirige al equipo), o
   - **http://192.168.4.1**
...
Este repositorio, tal como está, usa el servidor y claves de **prueba** definidos en `index/lib/defines.h` (`SERVER_URL`, `SERVER_HOST`, `API_KEY`, puerto LAN, etc.). Para un despliegue real hay que sustituirlos por los valores que entregue el equipo de plataforma **sin publicar claves secretas** en documentos abiertos.
